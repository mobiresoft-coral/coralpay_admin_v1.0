...
import type { ToolType, PluginToolType, InputToolType, NodeType, Plugin, NodeData } from "@/types"
...
export function isPluginOrInputTool(tool: unknown): tool is PluginToolType | InputToolType {
	return (
