...
import { Role, roles } from "@/app/(dashboard)/(partial-layout)/audit-log/data"
import {
...
const FilterModal: React.FC<FilterModalProps> = ({
	...
	const statusOptions = useMemo(() => STATUS_OPTIONS[reportType] || [], [reportType])
				...
				<div className="space-y-5">
					...
					{reportType === "audit" && (
						<div>
							...
							<select
								className={cn("w-full border rounded p-2", invalidRange && "border-red-500")}
								value={role}
